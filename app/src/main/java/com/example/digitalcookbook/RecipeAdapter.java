...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeListViewHolder> {
    ...
    public void onBindViewHolder(RecipeListViewHolder holder, int position) {
        ...
        int id = this.c.getResources().getIdentifier(imageResourceName, "drawable", this.c.getPackageName());
        ...
        holder1.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("TAG", "Ingredients = " + recipeList.get(holder1.getAdapterPosition()).getIngredients());
                Log.d("TAG", "Steps = " + recipeList.get(holder1.getAdapterPosition()).getSteps());
                Log.d("TAG", "Image = " + recipeList.get(holder1.getAdapterPosition()).getImageFileName());
                ...
                intent.putExtra("ImageFileName",recipeList.get(holder1.getAdapterPosition()).getImageFileName());
